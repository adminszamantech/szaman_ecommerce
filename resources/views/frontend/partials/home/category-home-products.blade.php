...
@foreach($category_wish_products as $product_category)
    ...
    <div class="Category-products flex flex-col gap-3 my-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-8 gap-4 items-center py-6">
                                    ...
                                    @if($ct_product->discount !== null)
                                        <div class="flex flex-row gap-2 items-center justify-center">
                                            <div class="flex flex-row justify-center items-center gap-x-0.5 text-[12px] font-bold line-through">
                                                <span><b>৳</b>{{ number_format($ct_product->unit_price) }}</span>
                                            </div>

                                            <div class="text-[13px] text-theme font-bold flex items-center">
                                                <span><b>৳</b>{{ number_format($ct_product->discount_price) }}</span>
                                            </div>
                                        </div>
                                    @else
        ...
        <div class="flex items-center justify-center">
            <a href="{{ route('frontend.category.page', $product_category->slug) }}" class="border border-theme px-4 py-1 uppercase rounded font-semibold text-theme hover:bg-theme hover:text-white">View All</a>
        </div>
    </div>
    <!--:::::::::::::::::: Category Loop :::::::::::::-->
@endforeach
